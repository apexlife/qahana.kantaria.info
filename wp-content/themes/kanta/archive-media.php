<?php get_header(); ?>
    ...
    <main class="al-main-media">
        <div class="container-fluid">
            <?php the_archive_title('<h2 class="al-head-title">', '</h2>'); ?>
                ...
                <div id="media-tab-videos" class="tab-pane fade in active">
                    <section class="al-playlist">
                        ...
                        if (have_posts()):  while (have_posts()): the_post();
                            ...
                            <p><?php echo awesome_get_terms( $post->ID, 'field' ); ?></p>
                            <p>
                            ...
                            <figure class="col-md-2">
                                    <div class="al-radius">
                                        ...
                                        <iframe width="100%" height="100%"
                                                src="https://www.youtube.com/embed/<?php echo get_post_meta($post->ID, 'youtube', true); ?>?controls=0&rel=0&showinfo=0&loop=0&egm=0&border=0&fs=0&disablekb=1&showsearch=0"
